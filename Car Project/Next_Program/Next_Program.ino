...
void auto_tracking(){
 ...
 if (sensorval=="10100" or sensorval=="00100" or sensorval=="01100" or sensorval=="11100" or sensorval=="11000"  or sensorval=="01000")
 {
...
if ( sensorval=="10000" )
 ...
 if (sensorval=="00101" or sensorval=="00110" or sensorval=="00111" or sensorval=="00011"  or sensorval=="00010" ){ //The black line is  on the right of the car, need  right turn
 
     go_Right();  //Turn right
       set_Motorspeed(SPEED,0);
     
    }
      if (sensorval=="00100"){ //The black line is  on the right of the car, need  right turn
